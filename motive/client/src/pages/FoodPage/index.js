        ...
        <div className='main-container'>
                ...
                <div className='food-content'>
                    ...
                    <div className='category-container'>
                        ...
                        <form onSubmit={handleCategory} className='food-form'>

                            <select name="category" className='food-category'>
                            ...
                            <span className='button'>
                                <input className='foodButton' type="submit" value="Select Cuisine" />
                            </span>
                        </form>
