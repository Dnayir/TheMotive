...
app.config.update(
    ...
    SESSION_REDIS=redis.from_url(
        "redis://:pd5b772b513d356ff7c0dd1514db19557505e48a390959bd4c93242382ad159ef@ec2-54-194-35-138.eu-west-1.compute.amazonaws.com:31459"),
...
def fetch_food_venues():
    if request.method == 'POST':
        try:
            ...
            url = "https://api.foursquare.com/v3/places/search?ll={},{}&categories={}&sort=DISTANCE&limit=25".format(
                lat, long, categories)
...
def user_review():
    try:
        ...
        new_review = Reviews(username=username, restaurant_name=restaurant_name,
                             type_of_food=type_of_food, review_description=review_description)
